...
EXECUTE IMMEDIATE 'truncate table CU6EMAIL_O_TABLE';
   ...
   OPEN c1;
     LOOP
--   FOR i IN 1..5 LOOP
      FETCH c1 INTO v_ORGKEY,v_PHONEEMAILTYPE,v_PHONEOREMAIL,v_PHONE_NO,v_PHONENOLOCALCODE,v_PHONENOCITYCODE,v_PHONENOCOUNTRYCODE,v_WORKEXTENSION,v_EMAIL,v_EMAILPALM,v_URL,v_PREFERRED_FLAG,v_Start_Date,v_End_Date,v_USERFIELD1,v_USERFIELD2,v_USERFIELD3,v_DATE1,v_DATE2,v_DATE3,v_BANK_ID;
     
      EXIT WHEN c1%NOTFOUND;  
            
      insert into CU6EMAIL_O_TABLE values (v_ORGKEY,v_PHONEEMAILTYPE,v_PHONEOREMAIL,v_PHONE_NO,v_PHONENOLOCALCODE,v_PHONENOCITYCODE,v_PHONENOCOUNTRYCODE,v_WORKEXTENSION,v_EMAIL,v_EMAILPALM,v_URL,v_PREFERRED_FLAG,v_Start_Date,v_End_Date,v_USERFIELD1,v_USERFIELD2,v_USERFIELD3,v_DATE1,v_DATE2,v_DATE3,v_BANK_ID ); 
