-- File Name		: drawdowntran_upload.sql

-- File Created for	: Upload file for drawdowntran
...
EXECUTE IMMEDIATE 'truncate table DRAWDOWNTRAN_O_TABLE';
...
--   FOR i IN 1..5 LOOP
      ...
      insert into DRAWDOWNTRAN_O_TABLE values (v_Indicator,v_Transaction_Type,v_Transaction_sub_Type,v_Account_Number,v_Currency,v_Service_Outlet,v_Amount,v_Part_tran_type,v_Type_of_demands,v_Value_Date,v_Flow_Id,v_Demand_Date,v_Last_part_transaction_flag,v_Tran_end_ind,v_Advance_Payment_Flag,v_Prepayment_Type,v_int_coll_on_prepayment_flg ); 
